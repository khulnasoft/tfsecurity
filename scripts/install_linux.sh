...
get_latest_release() {
  curl --silent "https://api.github.com/repos/khulnasoft/tfsecurity/releases/latest" | # Get latest release from GitHub api
...
download_file() {
  ...
  curl --fail --silent -L -o "${download_path}/${file}" "https://github.com/khulnasoft/tfsecurity/releases/download/${version}/${file}"
  dl_status=$?
